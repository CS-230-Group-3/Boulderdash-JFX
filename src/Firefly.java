 ...
 * Author: Oscar Baggs, Diya Patel
 * version 1.0.6
 */
public class Firefly extends Enemy {

    /**
     * The file path to the firefly's sprite image.
     */
    private static final String FILE_PATH = "resources/assets/firefly.png";

    /**
     * Indicates if the firefly favors anti-clockwise movement.
     */
    private boolean leftMoving;

    /**
     * Tracks the direction the firefly is currently "facing".
     */
    ...
    /**
     * Calculates the firefly's move priority based on its movement preference.
     ...
     * Executes the move if found, updating the firefly's position and direction.
     * If no valid move is found, the firefly does nothing.
     *
     * @param map the current level map.
     */
    ...
    /**
     * Moves the firefly in the specified direction by updating its position on the map.
     * This method is called by {@code calculateNextMove}.
     *
     * @param map the current level map.
     * @param dir the direction in which the firefly is moving.
     */
    @Override
